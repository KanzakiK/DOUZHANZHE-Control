...
app.MapPost("/api/uxtu/apply", (HttpContext ctx, SmuController smu) =>
{
    try
    {
        ...
        // cpuCoreLimit requires Process.ProcessorAffinity - handled separately
